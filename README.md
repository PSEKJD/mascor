...
[![arXiv](https://img.shields.io/badge/arXiv-2603.03484-b31b1b.svg)](https://arxiv.org/abs/2603.03484)
...
The full manuscript is available on **arXiv**: https://arxiv.org/abs/2603.03484
...
```
Typical installation time: 10–30 minutes (depending on system and network).
...
- **dataset/**
  - Download the full dataset from Kaggle:  
    https://www.kaggle.com/datasets/jeongdongkim/dataset-for-mascor-framework/data
  - Place the downloaded files in this directory.
  - `nasa_power/`: Retrieves meteorological datasets from the NASA POWER API for specified geographic sites if the data are not manually provided.
...
- **test/**
  - `oracle-dataset-construct/` : Construct oracle dataset via iteratively solving linear programming of e-fuel monthly operation    
